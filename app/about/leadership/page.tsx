      ...
      <section className="bg-slate-50 px-4 py-16 sm:py-24">
        <div className="container mx-auto max-w-6xl space-y-10">
          ...
          <Card className="overflow-hidden border-border/70 py-0 shadow-sm">
            <div className="sm:hidden bg-white p-5">
              <div className="flex items-start gap-4">
                <div className="relative h-36 w-28 shrink-0 overflow-hidden rounded-[22px] bg-slate-100">
                  <Image
                ...
                <div className="min-w-0 space-y-2">
                  ...
                  <p className="text-sm leading-6 text-muted-foreground">
                    Prophet Philip Banda is a Zambian-born Christian founder and
                    leader of Impact for Christ Ministries, based primarily in
                    South Africa and ministering across multiple countries in
                    the region.
                  </p>
                </div>
              </div>
              ...
              <Accordion type="single" collapsible className="mt-4">
                <AccordionItem value="profile">
                  <AccordionTrigger className="py-3 text-sm font-semibold text-foreground hover:no-underline">
                    About Prophet Philip Banda
                  </AccordionTrigger>
                  <AccordionContent className="text-sm leading-6 text-muted-foreground">
                    He is known as a humble servant of God who emphasizes
                    obedience to God, love for people, support for Israel,
                    adoration for the Jewish nation, and a ministry of
                    prophetic teaching, prayer, deliverance, miracle services,
                    and live Sunday broadcasts.
                  </AccordionContent>
                </AccordionItem>
            ...
            <div className="hidden sm:grid lg:grid-cols-[340px_minmax(0,1fr)]">
              <div className="relative min-h-[220px] overflow-hidden bg-slate-100 sm:min-h-[280px] lg:min-h-[340px]">
                <Image
                  src="/Prophet Philip Banda.png"
                  alt="Prophet Philip Banda"
                  fill
              ...
              <div className="space-y-5 bg-white p-5 sm:p-7 lg:p-8">
                <div className="space-y-3">
                  <div className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1.5 text-xs font-medium text-primary sm:px-4 sm:py-2 sm:text-sm">
                    Founder / Leader
                  </div>
            ...
            {leaders.map((leader) => (
              ...
              >
                <div className="bg-slate-50 px-6 pt-6">
                  <div className="relative mx-auto aspect-[4/5] w-full max-w-[220px] overflow-hidden rounded-[24px] bg-slate-100 shadow-sm">
                    <Image
                      src={leader.image}
                      alt={leader.name}
                      fill
